...
df = pd.read_csv('./data/input/train.csv')[:2000]
...
fm = pylibfm.FM(num_iter=50, verbose=True, task="regression", initial_learning_rate=1e-4, learning_rate_schedule="optimal")
